 ...
 * DTO for {@link Game}
 */
public record GameResponse (Long id, String title, Integer release, String publisher, String description, List<String> genres, BigDecimal price) {

    public GameResponse(Game game){
        this(game.getId(), game.getTitle(), game.getRelease(), game.getPublisher(), game.getDescription(), game.getGenres(), game.getPrice());
    }

    // Mappa från game till gameResponse
